...
namespace LabelPrint.Util
{
    ...
    public class Log
    {
        ...
        {
            if (flag == 0)
                Debug.WriteLine(TAG + DateTime.Now.ToString("HH-mm-ss") + " " + DateTime.Now.Millisecond.ToString() + data, "DD");
            else if (flag == 1)
                Console.WriteLine(TAG + DateTime.Now.ToString("HH-mm-ss") + " " + DateTime.Now.Millisecond.ToString() + data);
        }
