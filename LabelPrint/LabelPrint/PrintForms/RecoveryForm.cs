    ...
    public partial class RecoveryForm : Form
    {
	  SerialPort serialPort2;  //扫描枪
		...
		private int ToServer_recovery_barcode_upload()
		{
            ...
            str = UserInput.OutputBarcode + ";" + UserInput.TMaterialWeight + ";" + UserInput.OldCode1 + ";" + UserInput.OldCode2 + ";" +
                  UserInput.OldCode3 + ";" + UserInput.OldCode4 + ";" + UserInput.OldCode5 + ";" + UserInput.OldCode6 + ";" + UserInput.OldCode7 + ";" + UserInput.OldCode8 + ";" +
                  UserInput.OldCode9 + ";" + UserInput.OldCode10 + ";" + UserInput.WorkerNo;
            ...
            return 0; // m_FilmSocket.RecvResponse(1000);
		}
        ...
        private void button1_Click(object sender, EventArgs e)
        {
           ...
           //     MessageBox.Show("打印标签之前必须先扫描！");
            ...
            ToServer_recovery_barcode_upload();

            UserInput.SN = (Convert.ToInt16(UserInput.SN) + 1).ToString();
        }
