...
namespace LabelPrint
{
    public partial class PrintForm : Form
    {
        ...
        void initSerialPort()
        {
            ...
            {
                Console.WriteLine("Print form Open serial port1 failed!" + ex);
            }
            ...
            {
                Console.WriteLine("print form Open serial port2 failed!" + ex);
            }
        }
        ...
        private void UpdateUserInput()
        {
           ...
           // UserInput.MaterialName = tb_MaterialName1.Text;
            ...
            UserInput.InputBarcode = label7.Text;
...
//#endif
		...
		{
			//<上卷条码>;<成品大卷条码>;<重量>
            string str = UserInput.InputBarcode + ";" + UserInput.OutputBarcode + ";" + UserInput.Weight;
			byte[] send_buf = System.Text.Encoding.Default.GetBytes(str);
