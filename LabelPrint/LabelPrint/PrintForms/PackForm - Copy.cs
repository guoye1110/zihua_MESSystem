    ...
    public partial class packForm : Form
    {
        ...
        void serialDataReceived2(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            try
            {
                ...
                len = serialPort2.Read(serialDataBuf1, 0, serialPort2.BytesToRead);
        ...
        private void HandleBarcode(String barcode)
        {
            ...
            UserInput.Weight = tb_Roll_Weight.Text = tableArray[7];
            UserInput.PlateNo = tb_PlateNo.Text = tableArray[1];
            UserInput.ProductLength = tb_ProductLength.Text = tableArray[8];

            UserInput.ProductCode = cb_ProductCode.Text = tableArray[4];
            UserInput.LittleRollCount = tb_LittleRollCount.Text = tableArray[6];
            UserInput.BigRollNo = tb_BigRollNo.Text = tableArray[9];

            UserInput.OrderNo = tb_OrderNo.Text = tableArray[2];
            UserInput.OutputBarcode = lb_InputBarcode.Text;

            tb_BatchNo.Text = UserInput.BatchNo = tableArray[5];
        }
