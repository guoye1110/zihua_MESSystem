...
namespace LabelPrint.Data
{
    public partial class QAUserinputData : ProcessData
    {
        ...
        public Boolean CheckUserInput()
        {
            ...
            if (LittleRollNo.Length != 2)
            {
                System.Windows.Forms.MessageBox.Show("小卷号必须是2位");
                return false;
            }
            if (!checkWorkNoLen())
            {
        ...
        static String[] Column =
{
        ...
        class QASysData : ProcessSysData
    {
        ...
        String[] dataBase = { "id", "WorkerNo", "Date", "Time", "ProductCode", "RecipeCode", "WorkNo", "BatchNo", "CustomerName", "BigRollNo", "LittleRollNo", "Quality", "State", "ProductDesc" };
