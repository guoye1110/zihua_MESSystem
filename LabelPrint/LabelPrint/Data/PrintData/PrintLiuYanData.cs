 ...
 */
        override public void UpdatePrintPrintData(DynamicPrintLabelData DyData)
        {
            ...
            barcode.TimeStr = GetDateTimeForBarcode(); //.Remove(0, 2);
            ...
            {
                DyData.Quality = ProcessData.ProductQualityStrForComBoList[ProductQualityIndex];
                //print error details
            }
            ...
            {
                int QAstr = 1 + ProductQualityIndex;
                barcode.QAStr = "" + QAstr;
            }
            // barcode.QAStr = "0";
