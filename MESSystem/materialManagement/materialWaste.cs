...
{
    public partial class materialWaste : Form
    {
        ...
        public static materialWaste materialWasteClass = null; //it is used to reference this windows
        ...
        private void initializeVariables()
        {
            ...
            label1.Text = gVariable.enterpriseTitle + "报废料查询";
        ...
        private void displayMaterialList()
        {
            ...
            //int nameIndex;
            string name;
            int[] materialLenArray = { 1, 45, 110, 120, 120, 110, 110, 110, 100, 100, 80, 80};
            string[] materialColumnArray = 
            {
                "", "序号", "废料产生日期", "废料生产批次号", "废料产生工单", "产品编号", "产品名称", "客户", "废料产生设备", "废料产生原因", "负责员工", "废料数量",  
            };
            ...
            try
            {
                ...
                if (materialListArray != null)
                {
                    ...
                    for (i = 0; i < materialListArray.GetLength(0); i++)
                    {
                        ...
                        OptionItem.SubItems.Add(materialListArray[i, j++]);
                        OptionItem.SubItems.Add(materialListArray[i, j++]);
                        index = Convert.ToInt32(materialListArray[i, j++]);
                        OptionItem.SubItems.Add(gVariable.machineNameArrayDatabase[index]);
                        OptionItem.SubItems.Add(materialListArray[i, j++]);
                        name = toolClass.getNameByIDAndIDByName(null, materialListArray[i, j++]);
                        OptionItem.SubItems.Add(name);

                        OptionItem.SubItems.Add(materialInventoryList[i, j] + "kg");
            ...
            {
                Console.WriteLine("displayMaterialList in waste exception occurred!" + ex);
            }
        }
        ...
        string [,] getMaterialInventoryList()
        {
            ...
            tableName = gVariable.machineTableName;
        ...
        void getWasteMaterialData()
        {
            ...
            tableName = gVariable.wasteMaterialTableName;
