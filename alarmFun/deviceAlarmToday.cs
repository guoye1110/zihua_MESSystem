...
namespace MESSystem.alarmFun
{
    public partial class alarmListView : Form
    {
        ...
        string[] alarmMachineCodeArray = new string[ALARM_NUM_IN_ONE_SCREEN];
        ...
        private void deviceAlarm_Load(object sender, EventArgs e)
        {
            ...
            for (i = 0; i < gVariable.machineNameArrayForSelection.Length; i++)
            {
                comboBox1.Items.Add(gVariable.machineNameArrayForSelection[i]);
            }
        ...
        private void listView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                if (this.listView1.SelectedItems.Count > 0)
                {
                    ...
                    machineCode = alarmMachineCodeArray[index];
                    databaseName = toolClass.getDatabaseNameByMachineCode(machineCode);
        ...
        private string generateCommandText(string time1, string time2)
        {
            ...
            {
                condition1 = "machineName = '" + gVariable.machineNameArrayForSelection[machineSelected] + "'";
                andFlag = 1;
            }
