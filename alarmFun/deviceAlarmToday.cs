    ...
    public partial class alarmListView : Form
    {
        ...
        private void displayAlarmListView()
        {
            ...
            try
            {
                ...
                listView1.Columns.Add(gConstText.deviceAlarmListTitle2, (int)(dispatchLenArray[i++] * gVariable.screenRatioX), HorizontalAlignment.Center); //device name
                listView1.Columns.Add(gConstText.deviceAlarmListTitle3, (int)(dispatchLenArray[i++] * gVariable.screenRatioX), HorizontalAlignment.Center); //bin ID
