    ...
    public partial class historyDetailReview : Form
    {
        ...
        private void detailsForm_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                textBox1.Text += "【报警设备】：" + alarmTableStructImpl.machineName + lineFeed;
                
                if (alarmTableStructImpl.type == gVariable.ALARM_TYPE_MATERIAL)
                    textBox1.Text += "【报警设备料仓】：" + alarmTableStructImpl.feedBinID + lineFeed;
                ...
                else if (alarmTableStructImpl.type == gVariable.ALARM_TYPE_MATERIAL)
                {
                    ...
                    textBox1.Text += "【物料编码】：" + alarmTableStructImpl.errorDesc + lineFeed;
                }
