...
//                    button6.Enabled = false;
        ...
        public string setAlarmText(int alarmTextMode)
        {
            ...
            try
            {
                ...
                strText += "【报警设备】：" + machineCode + "(" + machineName + ")" + lineFeed;
                ...
                if (type == gVariable.ALARM_TYPE_QUALITY_DATA || type == gVariable.ALARM_TYPE_CRAFT_DATA)
                    ...
                    strText += "【报警员工】：" + operatorName + lineFeed;
...
//            int boardIndex;
            ...
            solution += gVariable.userAccount + " (" + DateTime.Now.ToString() + "):" + "确认报警取消" + editorLineFeed;
...
//            this.Close();
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            solution += gVariable.userAccount + " (" + DateTime.Now.ToString() + "):" + "确认报警处理完毕" + editorLineFeed;
...
//            this.Close();
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            solution_ = alarmTableStructImpl.solution + gVariable.userAccount + " (" + DateTime.Now.ToString() + "):" + textBox5.Text + editorLineFeed;
