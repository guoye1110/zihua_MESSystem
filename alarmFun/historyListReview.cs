...
namespace MESSystem.alarmFun
{
    public partial class historyListReview : Form
    {
        ...
        public void displayAlarmListView()
        {
            ...
            try
            {
                this.Text = gVariable.programTitle + gConstText.alarmListHistoryTitle[type];
                this.label1.Text = gConstText.alarmListTitle[type];

                this.listView1.BeginUpdate();

                listView1.Columns.Add(" ", 0, HorizontalAlignment.Center);
                listView1.Columns.Add(gConstText.deviceAlarmListTitle0, three_char_len, HorizontalAlignment.Center);  //id
                listView1.Columns.Add(gConstText.deviceAlarmListTitle1, ten_char_len, HorizontalAlignment.Center); //device failureNo
                listView1.Columns.Add(gConstText.deviceAlarmListTitle5, ten_char_len, HorizontalAlignment.Center); //failure description
                listView1.Columns.Add(gConstText.deviceAlarmListTitle12, 470, HorizontalAlignment.Center); //discuss
                listView1.Columns.Add(gConstText.deviceAlarmListTitle13, 450, HorizontalAlignment.Center); //solution
