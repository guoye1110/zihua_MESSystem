...
{
    public partial class materialRebuild : Form
    {
        ...
        public static materialRebuild materialRebuildClass = null; //it is used to reference this windows
        ...
        private void initializeVariables()
        {
            ...
            label1.Text = gVariable.enterpriseTitle + "再造料查询";
        ...
        private void displayMaterialList()
        {
            ...
            //int nameIndex;
            string name;
            int[] materialLenArray = { 1, 40, 80, 90, 110, 80, 70, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, };
            string[] materialColumnArray = 
            {
                //"", "序号", "产品编码", "产品名称", "BOM编码", "不良扫码日期", "不良条码", "不良再造日期", "再造料条码", "操作员工", "重用日期", "重用工单", "重用设备", "料仓号", 
                "", "序号", "不良再造日期","BOM编码","再造料条码","再造料重量","操作员工","不良条码1","不良条码2","不良条码3","不良条码4","不良条码5","不良条码6","不良条码7","不良条码8","不良条码9","不良条码10",
            };

            try
            {
                getMaterialRebuildData();
            ...
            {
                Console.WriteLine("displayMaterialList in rebuild exception occurred!" + ex);
            }
        }
        ...
        void getMaterialRebuildData()
        {
            ...
            tableName = gVariable.reuseMaterialTableName;
            ...
            {
                if (sthUpdated == 0)
                    str2 = " responsor = '" + workerIDList[workerIDSelected] + "'";
                else
                    str2 = " and customer = '" + workerIDList[workerIDSelected] + "'";
