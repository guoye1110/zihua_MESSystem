...
namespace MESSystem.materialManagement
{
    public partial class materialRebuild : Form
    {
        ...
        private void displayMaterialList()
        {
            ...
            //int nameIndex;
            //string name;
            int[] materialLenArray = { 1, 45, 90, 86, 65, 90, 166, 90, 166, 60, 90, 95, 80, 60};
            ...
            try
            {
                ...
                if (materialListArray != null)
                {
                    ...
                    for (i = 0; i < materialListArray.GetLength(0); i++)
                    {
                        ...
                        OptionItem.SubItems.Add(gVariable.machineNameArray[index]);
                        OptionItem.SubItems.Add(materialListArray[i, j++] + "号料仓");
