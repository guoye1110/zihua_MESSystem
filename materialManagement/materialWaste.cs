...
namespace MESSystem.materialManagement
{
    public partial class materialWaste : Form
    {
        ...
        private void displayMaterialList()
        {
            ...
            //int nameIndex;
            string name;
            int[] materialLenArray = { 1, 45, 110, 110, 130, 120, 100, 100, 80, 80};
            string[] materialColumnArray = 
            {
                "", "序号", "物料编码", "物料名称", "废料产生日期", "废料产生工单", "废料产生设备", "废料产生原因", "负责员工", "废料数量",  
            };
            ...
            try
            {
                ...
                if (materialListArray != null)
                {
                    ...
                    for (i = 0; i < materialListArray.GetLength(0); i++)
                    {
                        ...
                        OptionItem.SubItems.Add(materialInventoryList[i, j] + "千克");
