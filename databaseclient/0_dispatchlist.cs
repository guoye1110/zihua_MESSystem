...
namespace MESSystem.common
{
	public class dispatchlistDB : mySQLClass
	{
		...
		public string Serialize(dispatchlist_t st)
		{
			...
			str += st.waitForCheck  + ";" + st.wastedOutput 	+ ";" + st.workTeam 		+ ";" + st.batchNum2 	+ ";";
			str += st.batchNum3 		+ ";" + st.workshop 		+ ";" + st.workshift 		+ ";" + st.salesOrderCode 	+ ";";
			...
			str += st.batchNum1 	+ ";" + st.rawMaterialCode 	+ ";" + st.productLength 	+ ";" + st.productDiameter	+ ";";
		...
		public dispatchlist_t? Deserialize(string strInput)
		{
			...
			st.batchNum2 = input[SERIAL_NUMBER_INDEX];
			st.batchNum3 = input[REPORTER_INDEX];
			...
			st.batchNum1 = input[PRODUCT_COLOR_INDEX];
        ...
        public int writerecord(dispatchlist_t st)
        {
            ...
            try
            {
                ...
                myCommand.Parameters.AddWithValue(itemName[index++], st_dispatchlist.batchNum2);
                myCommand.Parameters.AddWithValue(itemName[index++], st_dispatchlist.batchNum3);
				...
				myCommand.Parameters.AddWithValue(itemName[index++], st_dispatchlist.batchNum1);
