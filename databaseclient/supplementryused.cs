...
{
	public class supplementryusedDB : mySQLClass
	{
        ...
        private const string c_TableName = "supplementryUsed";
        private const string c_FileName = "..\\..\\data\\globalTables\\supplementryused.xlsx";

		public struct supplementryused_t{
		...
		public string Serialize(supplementryused_t st)
		{
			string str = null;
		...
		public string[] Format(supplementryused_t st)
		{
			string str;
			string[] strArray;
		...
		public supplementryused_t ? Deserialize(string strInput)
		{
			string[] input;
			supplementryused_t st = new supplementryused_t();
        ...
        public int writerecord(supplementryused_t st)
        {
            int index;
            string[] itemName;
