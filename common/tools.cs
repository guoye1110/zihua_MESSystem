        ...
        */
        ...
        public static void getDummyData(int boardIndex)
        {
            ...
            try
            {
                ...
                gVariable.machineStatus[boardIndex].machineCode = gVariable.machineCodeArrayDatabase[boardIndex];
                gVariable.machineStatus[boardIndex].machineName = gVariable.machineNameArrayDatabase[boardIndex];
                ...
                {
                    gVariable.materialList[boardIndex].materialCode[i] = "03.1.06.00" + (i + 1);
                    gVariable.materialList[boardIndex].materialRequired[i] = (i * 40 + 605) * 2;
                }
        ...
        public static string generatingNewDispatch(int dispatchType, int boardIndex, int dispatchIndex)
        {
            ...
            switch(dispatchType)
            {
                case gVariable.DISPATCH_TYPE_PRODUCTION:
                    dispatchStr = gVariable.machineCodeArrayDatabase[boardIndex] + "_" + dispatchIndex.ToString().PadLeft(4, '0');
                    return dispatchStr;
