...
namespace MESSystem.common
{
    public partial class mySQLClass
    {
        ...
        public const int BAR_CODE_IN_DISPATCHLIST_DATABASE = 27;
        public const int BAR_CODE_RUSE_IN_DISPATCHLIST_DATABASE = 28;
        public const int QUANTITY_OF_RESUE_IN_DISPATCHLIST_DATABASE = 29;
        public const int MULTI_PRODUCT_IN_DISPATCHLIST_DATABASE = 30;
        public const int PRODUCT_CODE2_IN_DISPATCHLIST_DATABASE = 31;
        public const int PRODUCT_CODE3_IN_DISPATCHLIST_DATABASE = 32;
        public const int OPERATOR2_NAME_IN_DISPATCHLIST_DATABASE = 33;
        public const int OPERATOR3_NAME_IN_DISPATCHLIST_DATABASE = 34;
        public const int BATCH_NUMBER_IN_DISPATCHLIST_DATABASE = 35;
        ...
        { 
            ...
            gVariable.reuseMaterialTableName,   gVariable.wasteMaterialTableName, gVariable.changePartRecordTableName, gVariable.partsInventoryTableName, gVariable.materialInOutRecordTableName,
            gVariable.finalPackingTableName, gVariable.materialInventoryTableName, gVariable.productCastListTableName, gVariable.productPrintListTableName, gVariable.productSlitListTableName,
            gVariable.binInventoryTableName,  gVariable.materialPurchaseTableName, gVariable.dispatchCurrentIndexTableName,
        };
        public static string[] infoTableFileName1 = 
        {
            ...
            gVariable.reuseMaterialFileName,   gVariable.wasteMaterialFileName, gVariable.changePartRecordFileName, gVariable.partsInventoryFileName, gVariable.materialInOutRecordFileName,
            gVariable.finalPackingFileName, gVariable.materialInventoryFileName, gVariable.productCastListFileName, gVariable.productPrintListFileName, gVariable.productSlitListFileName,
            gVariable.binInventoryFileName, gVariable.materialPurchaseFileName, gVariable.dispatchCurrentIndexFileName
        };
        ...
        public static string[] infoDatabaseName2 = 
        {
            ...
            gVariable.basicInfoDatabaseName, gVariable.basicInfoDatabaseName, gVariable.basicInfoDatabaseName, gVariable.basicInfoDatabaseName, gVariable.basicInfoDatabaseName, 
            gVariable.basicInfoDatabaseName, gVariable.basicInfoDatabaseName, gVariable.basicInfoDatabaseName, gVariable.basicInfoDatabaseName, gVariable.basicInfoDatabaseName, gVariable.basicInfoDatabaseName, 
            gVariable.basicInfoDatabaseName, 
        };
        ...
        { 
            ...
            gVariable.castSpecTableName, gVariable.printSpecTableName, gVariable.slitSpecTableName, gVariable.castCraftTableName, gVariable.printCraftTableName, 
            ...
            gVariable.warehouseListTableName,
        };
        ...
        public static string[] infoTableFileName2 = 
        {
            ...
            gVariable.castSpecFileName, gVariable.printSpecFileName, gVariable.slitSpecFileName, gVariable.castCraftFileName, gVariable.printCraftFileName, 
            ...
            gVariable.warehouseListFileName,
        };
        ...
        public static gVariable.dispatchSheetStruct getDispatchByID(string databaseName, string tableName, int id)
        {
            ...
            try
            {
                ...
                if (myReader.Read())
                {
                    ...
                    if (!myReader.IsDBNull(BAR_CODE_IN_DISPATCHLIST_DATABASE))
                        dispatchList.barCode = myReader.GetString(BAR_CODE_IN_DISPATCHLIST_DATABASE);

                    if (!myReader.IsDBNull(BAR_CODE_RUSE_IN_DISPATCHLIST_DATABASE))
                        dispatchList.barcodeForReuse = myReader.GetString(BAR_CODE_RUSE_IN_DISPATCHLIST_DATABASE);

                    if (!myReader.IsDBNull(QUANTITY_OF_RESUE_IN_DISPATCHLIST_DATABASE))
                        dispatchList.quantityOfReused = myReader.GetString(QUANTITY_OF_RESUE_IN_DISPATCHLIST_DATABASE);
...
//                            dispatchList[index] = new gVariable.dispatchSheetStruct();
                            ...
                            if (!myReader.IsDBNull(BAR_CODE_IN_DISPATCHLIST_DATABASE))
                                dispatchList[index].barCode = myReader.GetString(BAR_CODE_IN_DISPATCHLIST_DATABASE);

                            if (!myReader.IsDBNull(BAR_CODE_RUSE_IN_DISPATCHLIST_DATABASE))
                                dispatchList[index].barcodeForReuse = myReader.GetString(BAR_CODE_RUSE_IN_DISPATCHLIST_DATABASE);

                            if (!myReader.IsDBNull(QUANTITY_OF_RESUE_IN_DISPATCHLIST_DATABASE))
                                dispatchList[index].quantityOfReused = myReader.GetString(QUANTITY_OF_RESUE_IN_DISPATCHLIST_DATABASE);
...
//                    gVariable.currentStatusForOneDay[i++] = (float)(Convert.ToDouble(myReader.GetString(DATA_VALUE1_IN_DATA_DATABASE)));
        ...
        public static int writeAlarmTable(string databaseName, string tableName, gVariable.alarmTableStruct alarmTableStructImpl)
        {
            ...
            try
            {
                ...
                myCommand.Parameters.AddWithValue(itemName[index++], alarmTableStructImpl.machineCode);
        ...
        public static gVariable.alarmTableStruct getAlarmTableContent(string databaseName, string tableName, int id) 
        {
            ...
            try
            {
                ...
                if (myReader.Read())
                {
                    ...
                    if (!myReader.IsDBNull(MACHINE_CODE_IN_ALARM_DATABASE))
                        alarmTableStructImpl.machineCode = myReader.GetString(MACHINE_CODE_IN_ALARM_DATABASE);
            ...
            try
            {
                ...
                if (dTable != null && dTable.Rows.Count != 0)
                {
                    ...
                    for (i = 0; i < BOMListImpl.numberOfTypes; i++)
                    {
                        ...
                        BOMListImpl.materialQuantity[i] = Convert.ToInt32(dTable.Rows[0].ItemArray[BOM_ITEM_QUANTITY1 + i * 3].ToString());
                    }
...
//            int num;
        ...
        public static int writeDataToDispatchListTable(String databaseName, String tableName, gVariable.dispatchSheetStruct dispatchImpl)
        {
            ...
            try
            {
                ...
                myCommand.Parameters.AddWithValue(itemName[index++], dispatchImpl.barCode);
                myCommand.Parameters.AddWithValue(itemName[index++], dispatchImpl.barcodeForReuse);
                myCommand.Parameters.AddWithValue(itemName[index++], dispatchImpl.quantityOfReused);
