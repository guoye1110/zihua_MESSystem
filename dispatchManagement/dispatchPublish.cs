    ...
    public partial class dispatchPublish : Form
    {
            ...
            try
            {
                ...
                if (dispatchListArray != null)
                {
                    ...
                    for (i = 0; i < dispatchListArray.Length; i++)
                    {
                        ...
                        if (nameIndex > gVariable.machineNameArray.Length)
                            nameIndex = 0;
                        OptionItem.SubItems.Add((i + 1).ToString());
                        OptionItem.SubItems.Add(gVariable.machineNameArray[nameIndex]);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (ret < 0)
                {
                    columnsDispatch = "machineID,dispatchCode,planTime1,planTime2,productCode,productName,operatorName,forcastNum,receiveNum,qualifyNum,unqualifyNum,processName,startTime,completeTime,prepareTimePoint,status,toolLifeTimes,toolUsedTimes,outputRatio,serialNumber,reportor,workShop,workShift,salesOrderCode,BOMCode,customer,barCode,barcodeForReuse,quantityOfReused,multiProduct,productCode2,productCode3,operatorName2,operatorName3";
                }
                else
                {
                ...
                if (ret < 0)
                {
                    columnsMaterial = "salesOrderCode,dispatchCode,machineID,machineName,status,numOfTypes,materialName1,materialCode1,materialRequired1,fullPackNum1,materialName2,materialCode2,materialRequired2,fullPackNum2,materialName3,materialCode3,materialRequired3,fullPackNum3,materialName4,materialCode4,materialRequired4,fullPackNum4,materialName5,materialCode5,materialRequired5,fullPackNum5,materialName6,materialCode6,materialRequired6,fullPackNum6,materialName7,materialCode7,materialRequired7,fullPackNum7,materialName8,materialCode8,materialRequired8,fullPackNum8";
                }
                else
                {
