            ...
            if (nCode == 0)
            {
                ...
                if (wParam == 0x100)//WM_KEYDOWN=0x100 
                {
                    ...
                    if (ts.TotalMilliseconds > 100)
                    {
                        //if (i == 1)
                        //{
                     //       toolClass.Log("TT", "MIMIsec=" + ts.TotalMilliseconds);
                        //}
                        i = 1;
                        //时间戳，大于50 毫秒表示手动输入
                        ...
                        Log.d("TT", "Data=" + sbBarCode.ToString());
                    ...
                    {
                        Log.d("AA", " barcode Length=" + sbBarCode.Length + " msg.message " + msg.message);
                        sbBarCode.Append(barCode.Chr.ToString());
                        ...
                        }
                        {
                            ...
                            t = new System.Timers.Timer(100);//实例化Timer类，设置时间间隔
                    ...
                    Log.d("HH"," barcode Length="+ sbBarCode.Length+ " msg.message "+ msg.message);
                    try
                    {
