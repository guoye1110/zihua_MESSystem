...
namespace MESSystem.communication
{
    public partial class communicate
    {
        ...
        const int COMMUNICATION_TYPE_DISPATCH_COMPLETED_TO_PC = -1;
        const int COMMUNICATION_TYPE_DISPATCH_DATA_FROM_PC = -2;
        ...
        const int COMMUNICATION_TYPE_QUALITY_DATA_TO_TOUCHPAD = -1;  //质量数据下发
                ...
                try
                {
                    ...
                    switch (dataTypeValue)
                    {
                        case DATA_TYPE_ADC_DEVICE:
                            ...
                            pos = PROTOCOL_DATA_POS;  //21, start position of adc data in buffer
                                    ...
                                    if (gVariable.checkDataCorrectness == 1)
                                    {
                                        if (gVariable.craftList[myBoardIndex].paramUpperLimit[i] != gVariable.craftList[myBoardIndex].paramLowerLimit[i] && (f < gVariable.craftList[myBoardIndex].paramLowerLimit[i] || f > gVariable.craftList[myBoardIndex].paramUpperLimit[i]))
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                alarmTableStructImpl.feedBinID = "4";
                                                alarmTableStructImpl.machineName = gVariable.machineNameArrayDatabase[myBoardIndex];
                                                ...
                                                alarmTableStructImpl.workshop = gVariable.machineWorkshopDatabase[0];
                        ...
                        case DATA_TYPE_QUALITY_DATA:
                            ...
                            if (i != 0)  //quality data not null
                            {
                                ...
                                //                                     gVariable.dispatchSheet[myBoardIndex].batchNum2.Remove(gVariable.LENGTH_DISPATCH_CODE + 1, 2) + qualityDataSN.ToString().PadLeft(2, '0'));
            ...
            */
            ...
            public int readMESString(int tableIndex)
            {
                ...
                try
                {
                    switch (tableIndex)
                    {
                        case COMMUNICATION_TYPE_DISPATCH_DATA_FROM_PC:
                            ...
                            if (gVariable.faultData == 0)
                            {
                                ...
                                //gVariable.dispatchSheet[myBoardIndex].workTeam = dispatchDataMES[0].singleFactor;
                            ...
                            else
                            {
                                ...
                                if(tableArray != null)
                                {
                                    //commandText = " where id = " + "'" + Convert.ToInt32(tableArray[0, 0]) + "'";
                                    //tableArray[0, 0] means the ID of the first dispatch by commandText 
                                    //gVariable.dispatchSheet[myBoardIndex] = mySQLClass.getDispatchByCommand(dName, tName, commandText);
                                }
                                else
                                {
                                ...
                                //gVariable.dispatchSheet[myBoardIndex].batchNum2 = gVariable.startingbatchNum2; //continue with previous serail number
                            }
                            ...
                            try
                            {
                                if (gVariable.faultData == 0)
                                {
                                    ...
                                    for (i = 0; i < num; i++)
                                    {
                                        ...
                                        {
                                            deviceAlarmListTable[i].feedBinID = "3";
                                            ...
                                            //for (j = 0; j < gVariable.deviceErrNoList.Length; j++)
                                            {
                                            //    if (deviceAndonResponse[i].faultDesc == gVariable.deviceErrNoList[j])
                                                {
                                            //        deviceAlarmListTable[i].errorDesc = gVariable.deviceErrDescList[j];
                                            //        break;
                                                }
                                            }
                                ...
                                else
                                {
                                    ...
                                    for (i = num; i >= 1; i--)
                                    {
                                        ...
                                        deviceAlarmListTable[j].feedBinID = "4";
                                        ...
                                        {
                                            deviceAlarmListTable[j].workshop = "制造一部";
                                        }
                                        ...
                                        deviceAlarmListTable[j].operatorName = toolClass.getNameByIDAndIDByName(null, gVariable.userAccount);
                ...
                try
                {
                    switch (tableIndex)
                    {
                        ...
                        case COMMUNICATION_TYPE_DISPATCH_COMPLETED_TO_PC:
                            ...
                            dispatchDataMES[0].entireLifeCount = gVariable.dispatchSheet[myBoardIndex].waitForCheck.ToString();
                            //dispatchDataMES[0].singleFactor = gVariable.dispatchSheet[myBoardIndex].workTeam;
            ...
            public string putVariableToTouchpadFormat(int index)
            {
                ...
                try
                {
                    ...
                    switch (index)
                    {
                        case COMMUNICATION_TYPE_DISPATCH_DATA_FROM_PC: //both original sheet and report sheet
                            ...
                            str6 = gVariable.dispatchSheet[myBoardIndex].workTeam;
                            str = getFixedCountString(gVariable.dispatchSheet[myBoardIndex].dispatchCode, 21) + "&" + getFixedCountString(time1, 13) + "&" + getFixedCountString(time2, 13) + "&" +
                                  ...
                                  getFixedCountString(((gVariable.dispatchSheet[myBoardIndex].wastedOutput ) + "/" + gVariable.dispatchSheet[myBoardIndex].waitForCheck), 11) + "&" +
                        ...
                        case COMMUNICATION_TYPE_DEVICE_ANDON_INQUIRY_TO_REQ:
                            for (i = 0; i < numOfDeviceAlarm; i++)
                            {
                                ...
                                str2 = deviceAlarmListTable[i].feedBinID;
                    ...
                    switch (tableIndex)
                    {
                        ...
                        case COMMUNICATION_TYPE_DEVICE_ANDON_TO_PC:
                            ...
                            if (clientFromTouchpad == 1)
                            {
                                ...
                                if (aa[0] < gVariable.deviceErrDescList.Length)
                                    deviceFailureIndex = aa[0];
                                else
                                    deviceFailureIndex = 0;
                                alarmTableStructImpl.operatorName = toolClass.getNameByIDAndIDByName(null, gVariable.userAccount);// strArray[3].Trim();
                            }
                            else
                            {
                            ...
                            alarmTableStructImpl.workshop = gVariable.machineWorkshopDatabase[3];
                        ...
                        case COMMUNICATION_TYPE_QUALITY_DATA_TO_PC:
                            ...
                            if (toolClass.isDigitalNum(strArray[i].Trim()) == 1)   //serial number should not be saved into quality list table, it is inside quality data table
                            {
                                ...
                                //    gVariable.qualityList[myBoardIndex].batchNum2 = Convert.ToInt32(strArray[i].Trim());
                                //else
                                //    gVariable.qualityList[myBoardIndex].batchNum2 = Convert.ToInt32(strArray[MAX_NUM_OF_QUALITY_DATA].Trim());
                            }
                            else
                            {
                                //gVariable.qualityList[myBoardIndex].batchNum2 = 0;
                            }
                        ...
                        case COMMUNICATION_TYPE_DISPATCH_COMPLETED_TO_PC:
                            ...
                            if (clientFromTouchpad == 1)
                            {
                                ...
                                gVariable.dispatchSheet[myBoardIndex].batchNum3 = strArray[13].Trim();
                            ...
                            else
                            {
                                ...
                                gVariable.dispatchSheet[myBoardIndex].batchNum3 = strArray[2].Trim();
                                gVariable.dispatchSheet[myBoardIndex].realFinishTime = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
                            }
                        ...
                        case COMMUNICATION_TYPE_MATERIAL_ANDON_TO_PC:
                            ...
                            if (clientFromTouchpad == 1)
                            {
                                ...
                                {
                                    i = strArray.Length;
                                    alarmTableStructImpl.operatorName = "王晓明"; // gVariable.dispatchSheet[myBoardIndex].operatorName;
                                }
                                else
                                {
                            ...
                            alarmTableStructImpl.workshop = gVariable.machineWorkshopDatabase[4];
                            alarmIDInTable = mySQLClass.writeAlarmTable(databaseNameThis, gVariable.alarmListTableName, alarmTableStructImpl);
            ...
            private void readBoardInfoFromMachineDataStruct(int doWeWantToChangedispatchUI)
            {
                ...
                dispatchCode = dispatchTools.getCurveInfoIngVariable(databaseNameThis, myBoardIndex, gVariable.CURRENT_READING);
            ...
            public void getdispatchUIInfoIngVariable(string databaseName)
            {
                ...
                gVariable.dispatchSheet[myBoardIndex].workshop = gVariable.strOfUnkown;
            ...
            public void sendStringToClient(string str, int type)
            {
                ...
                outPacket[PROTOCOL_COMMUNICATION_TYPE_POS] = (byte)type;
                outPacket[PROTOCOL_LEN_POS] = (byte)(len % 0x100);
                outPacket[PROTOCOL_LEN_POS + 1] = (byte)(len / 0x100);
                toolClass.addCrc32Code(outPacket, len);
