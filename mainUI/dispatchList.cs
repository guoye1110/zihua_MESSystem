...
//                    listView1.Columns.Add("刀具状态", 90, HorizontalAlignment.Left);
                    ...
                    for (i = 0; i < dispatchList.Length; i++ )
                    {
                        ...
                        //                        OptionItem.SubItems.Add(dispatchList[i].toolUsedTimes.ToString() + "/" + dispatchList[i].toolLifeTimes.ToString());
        ...
        private void listView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (this.listView1.SelectedItems.Count > 0)
                {
                    ...
                    toolClass.getCurveInfoIngVariable(gVariable.currentCurveDatabaseName, gVariable.boardIndexSelected, gVariable.HISTORY_READING);
