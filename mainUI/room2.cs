...
namespace MESSystem.mainUI
{
    public partial class room2 : Form
    {
        ...
        static string[] machineCode = { 
                                 "z000", "z132", "z021", "z013", "z089", "z058", "z034", "z019", "z056", "z045", 
                                 "z003", "z030", "z026", "z029", "z039", "z033", "z123", "z037", "z036", "z054",
                                 "z038", "z040", "z032", "z015", "z060", "z047", "z011", "z048", "z049", "Z000",
                                 "z042", "z000", "z000", "z116", "z010", "z017", "z018", "z000", "z000", "z000",
                                 "z117", "z050", "z055", "z115", "z103", "z022", "z023", "z057", "z031", "z052",
                                 "z035", "z028", "z100", "z041", "z043", "z025", "z046", "z016"
                                };

        string[] buttonName = new string[machineCode.Length];

        public static room2 room2Class = null; //it is used to reference this windows

        //when closing room2 class, closeReason = 0 means go back to face class, 1 means go to form1 class
        int closeReason;
        ...
        private void room_Load(object sender, EventArgs e)
        {
            ...
            this.Text = gVariable.programTitle + "齿轮车间精加工生产状况一览";
