...
namespace MESSystem.mainUI
{
    public partial class machineProgress : Form
    {
        ...
        const int numberOfMachineZihua = 17;
        ...
        string[] buttonName = new string[numberOfMachineZihua];
...
//            SetStyle(ControlStyles.UserPaint | ControlStyles.AllPaintingInWmPaint | ControlStyles.DoubleBuffer, true);
            ...
            try
            {
                ...
                for (i = 0; i < machineCodeZihua.Length; i++)
                {
                    ...
                    if (index == 0)
                        ...
                        buttonName[i] = "设备" + index + "\r\n" + gVariable.machineNameArrayDatabase[index - 1];
                }
        ...
        private void preparationForCurvedisplay(string databaseName)
        {
            ...
            dispatchTools.getCurveInfoIngVariable(databaseName, gVariable.boardIndexSelected, gVariable.CURRENT_READING);
...
//                        dispatchAlarmIDForOneDay[i, k] = value;
                    ...
                    if (gVariable.dispatchSheet[index].dispatchCode == null)
                        str = gVariable.machineNameArrayAPS[index] + "   当前工单: " + "工单未启动 ";
                    else
                        str = gVariable.machineNameArrayAPS[index] + "   当前工单: " + gVariable.dispatchSheet[index].dispatchCode + "; 操作员: " + gVariable.dispatchSheet[index].operatorName;
...
//                Console.WriteLine(DateTime.Now.ToString() + ":info into position");
        ...
        private string getTooltipData(string databaseName, int time, int index )
        {
            ...
            {
                commandText = "select * from `" + gVariable.dispatchListTableName + "` where id = " + "'" + index + "'";
                dispatchListImpl = mySQLClass.getDispatchByCommand(databaseName, commandText);
