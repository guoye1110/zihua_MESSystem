        ...
        void displayProductionProcess(int displayData)
        {
            ...
            try
            {
                if (tableArrayCasting != null)
                {
                    ...
                    commandText = "select * from `" + gVariable.materialInOutRecordTableName + "` where dispatchCode = '" + tableArrayCasting[0, 4] + "'";
                    ...
                    processData[1, 2] = gVariable.machineNameArray[Convert.ToInt32(tableArray[0, 6])];
                    ...
                    commandText = "select * from `" + gVariable.materialInOutRecordTableName + "` where id < '" + tableArray[0, 0] + "' and materialCode = '" + tableArray[0, 1] +
                    ...
                    processData[2, 2] = gVariable.machineNameArray[Convert.ToInt32(tableArrayCasting[0, 1])];
                    ...
                    if (tableArrayPrinting != null)
                    {
                        ...
                        processData[3, 2] = gVariable.machineNameArray[Convert.ToInt32(tableArrayPrinting[0, 1])];
                    ...
                    if (tableArraySlitting != null)
                    {
                        ...
                        processData[4, 2] = gVariable.machineNameArray[Convert.ToInt32(tableArraySlitting[0, 1])];
